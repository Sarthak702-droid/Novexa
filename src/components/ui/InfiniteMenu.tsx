  ...
  useEffect(() => {
    ...
    if (canvas) {
      try {
        ...
        console.error(e);
        // Fallback for when WebGL2 is not available
    ...
    <div className="relative w-full h-full text-foreground">
      ...
      {activeItem && (
        <>
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none translate-x-10 duration-[100ms]'
              : 'opacity-100 pointer-events-auto translate-x-0 duration-[500ms]'
          }
        `}
          >
            {activeItem.title}
        ...
        `}
          ...
          ${
            isMoving
              ...
              : 'bottom-8 md:bottom-16 opacity-100 pointer-events-auto duration-[500ms] scale-100 '
          }
        `}
        >
            <p className="select-none relative text-primary-foreground top-px text-3xl">&#x2197;</p>
          </div>
        </>
      )}
    </div>

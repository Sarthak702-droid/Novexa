    ...
    <div className="absolute top-[1em] z-[1000] w-full left-0 md:w-auto md:left-auto">
      ...
      >
        <Link
            ...
            role="menuitem"
            ref={logoRef}
            className="rounded-full px-4 py-2 inline-flex items-center justify-center overflow-hidden font-headline font-bold text-2xl text-white"
            style={{
              height: 'var(--nav-h)',
      ...
      >
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px]">
          {items.map(item => {
            ...
            const linkClasses =
              'block py-3 px-4 text-[16px] font-medium rounded-[50px] transition-all duration-200 ease-[cubic-bezier(0.25,0.1,0.25,1)] no-underline';
